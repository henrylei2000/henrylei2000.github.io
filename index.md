...
- Assembled and analyzed complex data to evaluate leading stocks within the e-commerce industry
- Observed calls and interviews with company executives and industry leaders to develop sources of information in preparation for research notes, sector pieces, and market overviews
- Monitored and synthesized news and events for biweekly client updates
...
- Built and tuned three-statement financial models for forecasting and valuations
- Assessed and analyzed the investment attractiveness of selected companies within an industry group
- Presented the industry report and stock initiations to portfolio managers and senior management
- Tools and Techniques
  - Python
  - Excel
  - SQL
...
- Won the top prize at the 2021 UPenn Climate Ventures featuring over 200 teams
...
- Developed a proof of concept for a neural network classifier to identify "good" or "bad" meats combos to optimize packing strategy and increase customer satisfaction
- Tools and Techniques
  - Python
  - Pandas
  - Scikit-learn
...
- Established a mathematical model to quantify the environmental impacts on U.S. counties from Chinese import competition from 1990 to 2015
